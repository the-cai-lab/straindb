...
public interface PlantSpeciesRepository extends JpaRepository<PlantSpecies, Integer> {
    // This interface will automatically provide CRUD operations for PlantSpecies entities
    // Additional custom query methods can be defined here if needed

    // return PlantSpecies by ncbi id
    Optional<PlantSpecies> findByNcbiid(Integer ncbiId);
