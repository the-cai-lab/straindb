...
public class Plants {
    ...
    @Column(length = 255, name = "growth_conditions")
    @Size(max = 255, message = "Growth conditions is too long, please try again.")
    ...
    private Boolean edited;
        ...
        // set default value and data transformation before new plant insert into table
    @PrePersist
    ...
    // set default value and data transformation before update plant record
    @PreUpdate
