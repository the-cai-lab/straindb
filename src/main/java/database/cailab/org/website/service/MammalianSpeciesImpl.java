...
@Service
public class MammalianSpeciesImpl implements MammalianSpeciesService {

    private final MammalianSpeciesRepository mammalianSpeciesRepository;

    public MammalianSpeciesImpl(MammalianSpeciesRepository mammalianSpeciesRepository) {
        this.mammalianSpeciesRepository = mammalianSpeciesRepository;
    }

    public List<MammalianSpecies> getAllMammalianSpecies() {
        return mammalianSpeciesRepository.findAll();
    }
